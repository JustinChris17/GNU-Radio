...
class RX_HackRF(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "RX_HackRF")
        ...
        self.osmosdr_source_0.set_sample_rate(48000)
        ...
        self.digital_gfsk_demod_0 = digital.gfsk_demod(
            ...
            verbose=False,
            log=False)
        self.blocks_threshold_ff_0 = blocks.threshold_ff(0, 1, 0.1)
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_ff(1)
        self.blocks_complex_to_mag_squared_0 = blocks.complex_to_mag_squared(1)
        self.blocks_char_to_float_0 = blocks.char_to_float(1, 1)
        self.audio_sink_1 = audio.sink(48000, "hackrf=1", True)
