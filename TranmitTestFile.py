...
class TranmitTestFile(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Transmit Test", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Transmit Test")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "TranmitTestFile")
        ...
        self._vol_win = RangeWidget(self._vol_range, self.set_vol, 'vol', "slider", float, QtCore.Qt.Horizontal)
        ...
        self.channels_channel_model_0 = channels.channel_model(
            ...
            noise_seed=0,
            block_tags=False)
        self.blocks_wavfile_source_0 = blocks.wavfile_source('recorded_audio_20250103131224.wav', True)
...
def main(top_block_cls=TranmitTestFile, options=None):
